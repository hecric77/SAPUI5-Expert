...
sap.ui.define([
    ...
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        let oMockServerInterface = {
            ...
            /**
             * Initialize the mock server asynchronously
             * @protected
            ...
            init: function(oOptionsParameter) {
                ...
                return new Promise (function(fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function(){
                        ...
                        let _sJsonFilesUrl = sap.ui.require.toUrl(_sJsonFilesPath);
                        ...
                        // configure mock server with the giving options or a default delay of 0.5s
                        MockServer.config({
                            autoRespond: true,
